...
\chapter{\texorpdfstring{Coisas admiráveis
\textsuperscript{⁠}}{Coisas admiráveis ⁠}}

\footnote{ In: \emph{Correio Paulistano} (SP), A Pedido, 27/11/1870,
  p.~2.}} % bruno: cap.21
...
\chapter{\texorpdfstring{\emph{cousas do sapientíssimo sr. dr.
felicio}}{cousas do sapientíssimo sr. dr. felicio}}
...
\chapter{\texorpdfstring{Questão fryer \& jones -- \emph{carta ao
advogado dr. pereira pinto
junior}}{Questão fryer \& jones -- carta ao advogado dr. pereira pinto junior}}
...
\part{\texorpdfstring{Luiz gonzaga \emph{afro} da
gama}{Luiz gonzaga afro da gama}}
...
\chapter{{[}sobre a comissão de classificação de escravos{]}\footnote{ In: \emph{Correio Paulistano} (SP), Seção Particular,
  17/03/1874, p.~2.}} % bruno: cap.54
...
\chapter{\texorpdfstring{Egrégio tribunal da relação \emph{--} j. geraud
-- petição de
habeas-corpus}{Egrégio tribunal da relação -- j. geraud -- petição de habeas-corpus}}
