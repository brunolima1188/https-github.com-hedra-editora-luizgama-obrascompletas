...
\chapter{{[}Joaquim Luiz Pizarro ao público ---
\textsc{ii}{]}\footnote{In: \emph{Revista Commercial} (SP), Publicações a
...
condensadas da noite do crime, derruiam de chofre\footnote{De um só
  ...
  Pedro \textsc{i}, em sentença passada em 15 de março de 1825.},
...
globosos\footnote{Que tem forma globular, arredondada. Por extensão de
  ...
  brasileiros do século \textsc{\textsc{xix}}. Teve destacada atuação política como
...
ilustrado monsenhor Dupanloup\footnote{Félix Antoine Philibert
  ...
  do século \textsc{\textsc{xix}}, como a infalibilidade da autoridade do papa. Como bispo
...
Tais foram as palavras do velho conselheiro José Bonifácio\footnote{
  ...
  século \textsc{\textsc{xix}}, dentre eles o de deputado constituinte em 1823. É ao
...
remate a obra péssima encetada pelo medo e pelo erro''.\footnote{A
  ...
  século \textsc{\textsc{xix}}, cf.~\emph{Recepção em Portugal das encíclicas sobre o
...
fidalgos e mercenários. É o respeitável sr. \emph{Laboulaye}\footnote{
  ...
  intelectuais e políticos da França do século \textsc{\textsc{xix}}.} quem vai falar.
...
Nijni\footnote{Refere-se à Nijni Novgorod, que foi um dos principais
  centros comercias da Rússia ao longo do século \textsc{\textsc{xix}}.}:
...
Aspromonte\footnote{Refere-se ao evento histórico conhecido como ``Dia
  ...
  em diversas lutas sociais do século \textsc{\textsc{xix}}.}?
...
o terrível aspecto do carbonarismo\footnote{Doutrina política da
  ...
  Itália no início do século \textsc{\textsc{xix}}.}.
...
\textsc{A MORTE DO ARQUIDUQUE MAXIMILIANO}\footnote{Fernando Maximiliano de
...
brasileiro.\footnote{O discurso de Victor Hugo na discussão do Projeto
  ...
  \emph{http://www.gipsa-lab.grenoble-inp.fr/~carlos.canudas-de-wit/other\_links/discurVictor\%20Hugo\_Education.htm}.}
...
\chapter{Instrução pública -- \textsc{ii}\footnote{In: \emph{Democracia} (SP),
...
século \textsc{\textsc{xix}}, que permanecia no pior dos mundos em matéria de educação de
...
\chapter{Instrução pública -- \textsc{iii}\footnote{In: \emph{Democracia} (SP),
...
\chapter{Instrução pública -- \textsc{v}}\footnote{In: \emph{Democracia} (SP),
...
\chapter{Instrução pública -- \textsc{vi}}\footnote{In: \emph{Democracia} (SP),
...
\chapter{Instrução pública -- \textsc{vii}}\footnote{In: \emph{Democracia} (SP),
...
permitiu em seus estados.}{\textsc{alfieri}\footnotemark}\footnotetext{Vittorio Alfieri (1749-1803) foi um dramaturgo, poeta
...
Novo Cipião\footnote{Refere-se a Cipião Emiliano Africano (185-29
  ...
  (149-146 a.C).}, \textsc{v}. Excia. fez, na estreita arena da câmara
...
\chapter{Carta ao exmo. sr. deputado dr. Tito A. P. de Mattos
{[}\textsc{iii}{]}\footnote{In: \emph{Democracia} (SP), 13/04/1868, pp.~1-2.
  Tito Augusto Pereira de Mattos (1835-1917), nascido na província da
  Bahia, foi um político, advogado, delegado de polícia, promotor
  público e juiz de direito. Foi deputado provincial em São Paulo entre
  1866 e 1869 e, anos depois, presidente da província do Maranhão
...
\textsc{propagação de luzes, reformação dos costumes}, clamam por toda a parte os
...
Feijó\footnote{Diogo Antonio Feijó (1784-1843) foi um sacerdote
  ...
  postos-chave na política da primeira metade do século \textsc{\textsc{xix}}, dentre eles
...
jazia na sua repartição há \textsc{cem dias}, em uma das respectivas seções,
...
\chapter{As aulas noturnas {[}ii{]}}\footnote{In: \emph{Radical Paulistano}
...
\chapter{Mais um escândalo}\footnote{In: \emph{Radical Paulistano} (SP),
  16/07/1869, p.~3.}
...
\chapter{Foro da capital {[}caso antonio encarnação{]}}\footnote{In:
...
importante cidade de Jundiaí, as quais \textsc{todas} deram-se de suspeitas!...
...
\chapter{Processo de lorena}\footnote{In: \emph{Radical Paulistano} (SP), A
...
cruento martírio de Ratcliff\footnote{João Guilherme Ratcliff
  ...
  traição'', por ordem do imperador Pedro \textsc{i}, em sentença passada em 15 de
...
Há, portanto, \textsc{\textsc{xix}} séculos que, como iníqua\footnote{Perversa,
...
\textsc{v. duruy}\footnote{Victor Duruy (1811-1894) foi um historiador e
...
inspirados Doroteus\footnote{Referência a Doroteu, historiador e
  ...
  jurídicos publicados sob a autoridade do imperador Justiniano \textsc{i}
  (483-565).}.
...
\textsc{requeria ao juízo competente?!}...
...
\textsc{perseguirá}!!!...''. Ao que Gama arrematou: ``E a demissão realizou-se!...
Resta a perseguição, que de ânimo tranquilo aguardo''.
\end{didascalia}
