...
\chapter{Epístola familiar\footnote{In: \emph{O Cabrião} (\textsc{sp}), 16/12/1866, pp.~3, 6--7.}} %pp. 3, 6 e 7 mesmo?
...
\chapter{Resposta a «Mustela»\footnote{In: \emph{Correio Paulistano} (\textsc{sp}), A Pedido, 06/12/1866, p.~2.}}
...
\chapter{Carta a «Abdallah»\footnote{In: \emph{Correio Paulistano}
...
\footnotetext{Fernando Maximiliano de
...
infeliz.\footnote{Referência indireta a Fernando Maximiliano de
  ...
  México (1864--1867). As forças constitucionais, no entanto, lideradas
  pelo presidente da República, Benito Juárez, restauraram o poder
  republicano, após capturar e fuzilar, em Querétaro, o autoproclamado
...
textos ---} ``Instrução Pública'' ---, Afro\emph{-Gama estabelece
...
comparações retóricas que transitavam habilmente entre o religioso e o
...
% \textbf{*didascália*}
\begin{didascalia}
Afro 1°-\emph{Gama dá continuidade ao primeiro texto, reforçando as
...
% \textbf{*didascália*}
\begin{didascalia}
Afro 1°-\emph{Gama retorna à terceira parte da série} ``Instrução Pública''
