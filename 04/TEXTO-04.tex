...
\chapter{Epístola familiar\footnote{\emph{O Cabrião} (\textsc{sp}), 16/12/1866, pp.~3, 6--7.}} %pp. 3, 6 e 7 mesmo?
...
\chapter{Joaquim Luiz Pizarro ao público I\footnote{\emph{Revista Commercial} (\textsc{sp}), Publicações a pedido, {[}sem título{]}, 06/04/1867, p.~3.}}
...
\footnotetext{\emph{Correio Paulistano} (\textsc{sp}), A Pedido, 22/02/1867, p.~3.}
