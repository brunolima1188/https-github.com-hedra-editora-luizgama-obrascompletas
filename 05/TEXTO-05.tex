...
\chapter{Calúnia calculada\footnote{\emph{Radical Paulistano} (SP), {[}editorial{]}, 08/01/1870, p.~1.}} % bruno: cap.1
...
\chapter{Seriedade e riso\footnote{\emph{Radical Paulistano} (SP), Fatos diversos,
...
Deram agora de libertar todo o escravo que atinge a idade de 50 ANOS!\ldots{}
...
\chapter{Emancipação\footnote{\emph{Radical Paulistano} (SP), Fatos diversos,
...
\chapter{Firmino moreira dos santos\footnote{\emph{Correio Paulistano} (SP), A Pedido, 13/01/1870,
  p.~2.}} % bruno: cap.4
...
\chapter{O sr. luiz gama\footnote{\emph{Correio Paulistano} (SP), A Pedido, 09/02/1870,
  p.~3.}} % bruno: cap.5
...
\chapter{1. distinto redator {[}réplica{]}\footnote{\emph{Correio Paulistano} (SP), A Pedido, 11/02/1870,
  p.~3.}} % bruno: cap.5
...
\chapter{Foro de jundiaí -- (delegacia de polícia)\footnote{\emph{Correio Paulistano} (SP), A Pedido, 07/07/1870,
...
\chapter{Para o sr. dr. juiz de direito ver\footnote{\emph{Correio Paulistano} (SP), A Pedido, Ao Público,
...
\chapter{Ainda a prisão do artista leal {[}i{]}\footnote{\emph{Correio Paulistano} (SP), A Pedido, Ao Público,
...
\chapter{Ainda a prisão do artista leal {[}ii{]}\footnote{\emph{Correio Paulistano} (SP), A Pedido, Ao Público,
...
\chapter{Reforma do foro\footnote{\emph{Correio Paulistano} (SP), A Pedido, Ao Público,
...
\chapter{Tribunal do júri\footnote{\emph{Correio Paulistano} (SP), A Pedido, 17/12/1870,
  p.~3.}} % bruno: cap.11
...
\chapter{A pensão aos filhos do senador furtado\footnote{\emph{Correio Paulistano} (SP), A Pedido, 17/08/1870.}}% bruno: cap.12
...
\chapter{Jacareí\footnote{\emph{Correio Paulistano} (SP), A Pedido, 11/09/1870,
  p.~3.}} % bruno: cap.13
...
\chapter{Ao público\footnote{\emph{Correio Paulistano} (SP), 24/09/1870, p.~2.}} %bruno: cap.15
...
\chapter{Comarca de campinas\footnote{\emph{Correio Paulistano} (SP), A Pedido, 15/10/1870,
  pp.~2--3.}} % bruno: cap.16
...
\chapter{Escândalo -- \textsc{i}\footnote{\emph{Correio Paulistano} (SP), A Pedido, 19/10/1870,
  p.~3.}} % bruno: cap.18
...
\chapter{1. Escândalo -- \textsc{i} {[}réplica{]}\footnote{\emph{Correio Paulistano} (SP), A Pedido, 20/10/1870,
  p.~3.}} % bruno: cap.18
...
\chapter{Escândalo -- \textsc{ii}\footnote{\emph{Correio Paulistano} (SP), A Pedido, 21/10/1870,
  p.~3.}} % bruno: cap.19
...
\chapter{Mais três\ldots{}\footnote{\emph{Correio Paulistano} (SP), A Pedido, 22/10/1870,
  p.~3.}} % bruno: cap.20
...
\chapter{Coisas admiráveis\footnote{\emph{Correio Paulistano} (SP), A Pedido, 27/11/1870,
  p.~2.}} % bruno: cap.21
...
\chapter{1. Cousas admiráveis {[}réplica{]}\footnote{\emph{Correio Paulistano} (SP), A Pedido, 29/11/1870,
  pp.~2--3.}} % bruno: cap.21
...
\chapter{Cousas admiráveis\footnote{\emph{Correio Paulistano} (SP), A Pedido, 30/11/1870,
  p.~2.}} % bruno: cap.22
...
bárbaro delito\ldots{}\footnote{ A menção a esse crime não passaria
  ...
  desta capital''. Cf. \emph{Correio Paulistano} (SP), A Pedido,
...
\chapter{1. {[}Tréplica de raphael tobias de aguiar{]}\footnote{\emph{Correio Paulistano} (SP), A Pedido, Ao Público,
...
\chapter{Cousas admiráveis\footnote{\emph{Correio Paulistano} (SP), A Pedido, 02/12/1870,
  pp.~2--3.}} % bruno: cap.23
...
\chapter{Questão do pardo narciso\footnote{\emph{Correio Paulistano} (SP), A Pedido, 04/12/1870,
  p.~2.}} % bruno: cap.24
...
\chapter{Aos abolicionistas da escravidão\footnote{\emph{Correio Paulistano} (SP), 15/12/1870, A Pedido,
  p.~3.}} % bruno: cap.25
...
\chapter{Carta a ruy barbosa\footnote{Fundação Casa de Rui Barbosa, 18/06/1871.}}% bruno: cap.26
...
\chapter{Foro de jundiaí -- (delegacia de polícia)\footnote{\emph{Correio Paulistano} (SP), A Pedido, 01/10/1871,
  p.~2. Jundiaí, município paulista que fica 50 km distante de São Paulo
...
\chapter{Foro da capital\footnote{\emph{Correio Paulistano} (SP), A Pedido, 01/11/1871,
  p.~2.}} % bruno: cap.28
...
\chapter{Loja américa\footnote{\emph{Correio Paulistano} (SP), A Pedido, 10/11/1871,
  p.~2.}} % bruno: cap.29
...
\chapter{Luiz g. p.~gama\footnote{\emph{Correio Paulistano} (SP), A Pedido, 10/11/1871,
  pp.~2--3.}} % bruno: cap.30
...
\chapter{Até que seja satisfeito\footnote{\emph{Correio Paulistano} (SP), A Pedido, 10/11/1871,
...
\chapter{Província de São Paulo -- foro da capital\footnote{\emph{A República} (RJ), Ineditoriais, 01/01/1872, p.~4.
...
\chapter{Foro da capital -- juízo municipal\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Jundiaí\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Caso virgem\footnote{\emph{Correio Paulistano} (SP), A Pedido, 14/04/1872,
  p.~3.}} % bruno: cap.35
...
\chapter{1. caso virgem {[}réplica{]}\footnote{\emph{Correio Paulistano} (SP), A Pedido, 16/04/1872,
  pp.~2--3.}} % bruno: cap.35
...
\chapter{Foro da capital\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{1. Foro da capital {[}réplica{]}\footnote{\emph{Diário de São Paulo} (SP), Publicações Pedidas,
...
\chapter{Juízo de direito\footnote{\emph{Correio Paulistano} (SP), Seção Particular, Foro
...
\chapter{Foro de jacareí\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Repartição da polícia\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Cousas do sapientíssimo sr. dr. felicio\footnote{\emph{Correio Paulistano} (SP), Foro da Capital, Juízo
...
1ª -- A escrava F\ldots{} podia requerer o depósito de sua pessoa, como
...
\chapter{O sr. Percy John Fryer\footnote{\emph{Correio Paulistano} (SP), Seção Particular, Foro da Capital, Juízo Municipal, 13/09/1872, p.~2.}} % bruno: cap.44
...
\chapter{1. Juízo municipal {[}réplica{]}\footnote{\emph{Correio Paulistano} (SP), Seção Particular, Foro
...
\chapter{Questão fryer \& jones -- carta ao advogado dr. pereira pinto junior\footnote{\emph{Correio Paulistano} (SP), Seção Particular, Foro
...
\chapter{Subscrição em favor da família do finado brigadeiro oliveira\footnote{\emph{Correio Paulistano} (SP), A Pedido, 12/11/1871,
  p.~2.}} % bruno: cap.46
...
\chapter{Aos srs. assinantes da república\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Carta ao sr. eloy ottoni\footnote{\emph{Correio Paulistano} (SP), Seção Particular, Os
...
\chapter{1. carta a luiz gama\footnote{\emph{Correio Paulistano} (SP), Seção Particular, Os
  pobres de Santa Ephigenia, 29/08/1872, p.~2.}} % bruno: cap.48
...
\chapter{Ainda o congresso republicano em itu\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{O imperador e a liberdade de imprensa\footnote{\emph{Correio Paulistano} (SP), Crônica Política,
...
Imperial\footnote{\emph{Correio Paulistano} (SP), 27/02/1874, p.~2.
...
de escravos{]}\footnote{\emph{Correio Paulistano} (SP), Seção Particular, 17/03/1874, p.~2.}} % bruno: cap.54
...
\chapter{Franca ao imperador\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Aos srs. redatores de jornais\footnote{\emph{A Província de São Paulo} (SP), Seção Livre,
...
\chapter{O julgamento da falência de julio geraud\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{1. a propósito do julgamento da falência de julio geraud\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Egrégio tribunal da relação -- j. geraud -- petição de habeas-corpus\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Ao público\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Ao sr. exmo. sr. ministro da justiça\footnote{\emph{Correio Paulistano} (SP), Seção Particular,
...
\chapter{Ribeirão preto\footnote{\emph{A Província de São Paulo} (SP), Seção Livre,
