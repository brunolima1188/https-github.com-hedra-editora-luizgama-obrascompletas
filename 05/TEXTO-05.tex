...
\chapter{Calúnia calculada\footnote{\emph{Radical Paulistano} (\textsc{sp}), {[}editorial{]}, 08/01/1870, p.~1.}} % bruno: cap.1
...
\chapter{Firmino moreira dos santos\footnote{\emph{Correio Paulistano} (\textsc{sp}), A Pedido, 13/01/1870,
  p.~2.}} % bruno: cap.4
...
\chapter{Tribunal do júri\footnote{\emph{Correio Paulistano} (\textsc{sp}), A Pedido, 17/12/1870,
  p.~3.}} % bruno: cap.11
...
\chapter{A pensão aos filhos do senador furtado\footnote{\emph{Correio Paulistano} (\textsc{sp}), A Pedido, 17/08/1870.}}% bruno: cap.12
...
\chapter{Jacareí\footnote{\emph{Correio Paulistano} (\textsc{sp}), A Pedido, 11/09/1870,
  p.~3.}} % bruno: cap.13
...
\chapter{Ao público\footnote{\emph{Correio Paulistano} (\textsc{sp}), 24/09/1870, p.~2.}} %bruno: cap.15
...
\chapter{O sr. Percy John Fryer\footnote{\emph{Correio Paulistano} (\textsc{sp}), Seção Particular, Foro da Capital, Juízo Municipal, 13/09/1872, p.~2.}} % bruno: cap.44
...
\chapter{Questão fryer \& jones -- carta ao advogado dr. pereira pinto junior\footnote{\emph{Correio Paulistano} (\textsc{sp}), Seção Particular, Foro
  ...
  \emph{Correio Paulistano} (\textsc{sp}), Correio da Corte, 22/08/1871, p.~ 1.}} % bruno: cap.45
...
de escravos{]}\footnote{\emph{Correio Paulistano} (\textsc{sp}), Seção Particular, 17/03/1874, p.~2.}} % bruno: cap.54
