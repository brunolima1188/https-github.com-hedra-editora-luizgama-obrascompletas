...
\begin{argumento}
Na última edição do \textnormal{Radical Paulistano},
os redatores tinham os olhos voltados para o ano de 1869, que recém-terminara. Gama certamente ficou até o fim, até a última máquina
tipográfica parar. A luta política que ele travou nos últimos meses do
ano velho deixou sequelas tamanhas que teria de recomeçar novas
batalhas. Afinal, sem o emprego e os aliados de antes, a vida tomaria novo
...
momento, o evento passou à historiografia. Mas essa é outra história
...
riso'' e ``Emancipação'', não só têm marcas estilísticas e
repertórios de metáforas de Gama, como também tratam de assuntos de que
ele se encarregava na redação. Os três indicativos, somados à
hora crucial em que se encontrava o \textnormal{Radical Paulistano}, convergem
para a autoria de Gama. É~de notar, finalmente, que os artigos do
último \textnormal{Radical} possuíam uma estrutura semelhante: recortavam uma notícia
...
militar contra um veterano de guerra ``inválido'' em seu quartel.
\end{argumento}
...
um procedimento administrativo ordinário apenas, mas
...
No \emph{Dezesseis de Julho}, nº 36, de 23 do pretérito,\footnote{
  ...
  não há tal seção e conteúdo na de 23 de dezembro de 1869. Assim, teria
  escrito esse texto em finais de 1869, não a tempo, porém,
...
\chapter{Seriedade e riso\footnote{\emph{Radical Paulistano} (\textsc{sp}), Fatos diversos,
  08 de janeiro de 1870, p.\,3.}} % bruno: cap.2

\begin{didascalia}
O redator do \textnormal{Radical Paulistano} comenta mais uma notícia,
...
conhecida. ``Quando pensaríamos nós'', ironizava Gama, ``que
...
\begin{quote}
O Mosteiro de São Bento do Rio de Janeiro, desde o 1º de junho até 30 de
...
(!!!)\footnote{ As exclamações e os comentários nesse recorte do jornal %Quais comentários?
  \emph{O Apóstolo} são originais do redator do \emph{Radical
  Paulistano}.} %Manter exclamações entre parênteses? A nota já explica que é um comentário de Gama...
...
É o caso de exclamar com o \textsc{real} Profeta: \emph{A iniquidade}\footnote{ %manter c.a.?
...
dos que se dizem \emph{liberalões}, quer dos que se dizem %constitucionalões mesmo?
...
\emph{gatos pingados} para consolar a humanidade civilizada em seus
ardentes desejos de ver para sempre extinta a escravidão do homem pelo
homem?

É que a \textsc{dama política} tem laringe de sabiá e estômago de %manter c.a.?
abutre!\footnote{ A transcrição, salvo a caixa alta na palavra
  ``real'', confere exatamente com o original. Os grifos em itálico e as
  exclamações são do redator de \emph{O~Apóstolo}. Cf. \emph{O Apóstolo}
  (\textsc{rj}), 05 de dezembro de 1869, Chronica Nacional, pp.\,387--388.}
\end{quote}  
...
merinó!\ldots{}\footnote{ Tecido de lã de carneiro.}
...
\begin{didascalia}
Como sugerido já na primeira frase, o artigo estabelece uma linha
de continuidade com ``Seriedade e riso'', razão que reforça a ideia
...
beneditinos, é a eles que o redator do \textnormal{Radical Paulistano} dirige
...
arroubamento pelos seletos redatores do \emph{Apóstolo}.\footnote{ O
  redator comenta o mote do artigo precedente, a notícia publicada pelo jornal católico \emph{O Apóstolo} (\textsc{rj}). A maneira como a qualifica reforça a ideia de que ambos os textos foram escritos pelo mesmo autor.}
...
sacrifícios.\footnote{ Embora adaptada, a transcrição é bastante
  ...
  distinto, 30 de outubro de 1869, pp.\,1--2.}
\end{quote}  
...
texto, a tortura contra Firmino Moreira dos Santos, soldado e veterano da
Guerra do Paraguai. O ``castigo abominável'' infligido contra o
...
submetido ao pesado e afrontoso castigo do sarrilho\footnote{ Não se
  ...
  alguém inválido ao serviço do sarilho: organizar as
  ...
  Guerra do Paraguai (1865--1870). Cf. Mário Maestri, ``Pranchada
  infamante: resistência ao castigo físico do soldado imperial na guerra
  contra o Paraguai'', \emph{De Raíz Diversa, Revista Especializada en Estudios
  Latinoamericanos}, vol.\,1, no.\,2, out.-dez., 2014, pp.\,125--153,
...
estas linhas não tenho em mente molestá-lo.\footnote{ É de se notar
  ...
  bastante semelhante. Em ``Questão de liberdade'', Gama concluiu seu
  ...
  ``Foro de Belém de Jundiaí'', Gama se via, em suas palavras,
  ...
  quem se opunha. Cf. ``Questão de liberdade'',
  13 de março de 1869, Correio Paulistano; e ``Foro do Belém de Jundiaí'',
  30 de setembro de 1869, Correio Paulistano. (Grifos meus.)}

Não é justo, porém, que passem em silêncio fatos desta ordem, que podem
...
\textsc{philodemo}\footnote{Sobre o pseudônimo reconhecido por Gama veja, no
  quarto volume destas \textit{Obras completas}, a seção ``A escrava Brasília:
...
da São Paulo da época. Nesta seção, veremos dois casos relacionados a
três cidades do interior paulista: Amparo, Campinas e Jundiaí.
As localidades expressam um fenômeno que se verificaria ao
longo da década: a interiorização da ação jurídica de Gama.
O~primeiro texto é revelador das
dificuldades que encontraria. Tratava-se de uma
...
escravizados não seriam genuínos sentimentos humanitários. No
entanto, por trás da da discussão retórica moral, estava uma causa de
liberdade explosiva: o inventário de um certo comendador Ferreira Netto, proprietário
legal de duzentos e dezessete negros e
negras escravizados --- o que a historiografia chama de megaescravaria---, divididos entre fazendas de
...
causa. À~época, aquela simples provocação poderia representar
muito mais do que o palavrório moralista parecia indicar. E a resposta
de Gama, que se lê em seguida, não poderia ser mais enfática.
Independentemente de intimidação, indicava que se dedicaria de corpo e alma à
libertação do que o ``Homem Livre'', de forma pejorativa e 
infame, chamava de ``grande ninhada'' e que  Gama considerava como
seus ``irmãos de infortúnio''. A segunda causa que
compõe essa seção se passa na delegacia de polícia de Jundiaí. Um
ex-colega de farda --- um agente da Força Pública, instituição a que
...
dos direitos do agente João Francisco de Oliveira. A prisão ilegal deixou Gama furioso.
...
modo didático, patente ao público, além de servir-lhe para
``judiciosamente julgar o modo pelo qual são cumpridos e
guardados os preceitos legais neste portentoso império do Brasil''. Em
passagens prenhes da verve que todos nós reverenciamos, lemos como ele
arremata dois pássaros com a mesma canetada. Por um lado,
ponderava, ``assim como é possível que eu desvairado pela liberdade tenha
perdido o bom senso'', poderia, por outro, ``afirmar com ousadia
que o bom senso não será encontrado nos gabinetes dos assessores de
Jundiaí''. Levantava a bandeira ao passo que caía o juiz.
\end{argumento}

\chapter{O Sr.\,Luiz Gama\footnote{\emph{Correio Paulistano} (\textsc{sp}), A Pedido, 09 de fevereiro de 1870, p.\,3.}} % bruno: cap.5
...
sagrado já não arde, podeis tropeçar nas piras.\footnote{ Vestal,
  ...
  ``até hoje tem sido o teu coração um templo''. Pelo desfecho,
...
\chapter{Distinto redator {[}réplica{]}\footnote{\emph{Correio Paulistano} (\textsc{sp}), A Pedido, 11 de fevereiro de 1870,
  p.\,3.}} % Manter como cap. ou section? por ser réplica seria section, mas o texto é de Gama...

\begin{didascalia}
A réplica de Gama ao artigo do ``Homem Livre'' é sóbria,
...
Livre'' --- que, para maior ironia, seria até correligionário de
...
para fazer algo. Três meses depois desse artigo de resposta, Gama
seria oficialmente nomeado o representante das mais de duas centenas de
...
magna questão a que vou meter ombros.\footnote{ Atirar-se ao trabalho,
...
\begin{didascalia}
Literatura normativo-pragmática. Um agente da Força Pública encontrava-se preso
...
delito; 2º, \emph{quando indiciado} em crime inafiançável --- art. 179, §\,8º da Constituição, 131, 133 e 175 do Código do
Processo Criminal.}{\textsc{senador p.\,bueno}, \textit{Apontamentos sobre o processo criminal brasileiro}\footnotemark}

\footnotetext{José Antonio Pimenta Bueno (1803--1878), o\label{bueno}
...
julgou o corpo de delito; a petição solicitando a retardada
...
setembro de 1860,\footnote{ Curiosamente, o decreto citado versava
  ``sobre o processo nos crimes de furto de gado \textit{ad vacuum}'', i.e., no
...
A queixa foi dada no dia 2, às 8 horas da manhã, e jurado no dia 4 à 1 hora da tarde; e a ordem de soltura passada a 1º não se
cumpriu!\ldots{})
...
\begin{argumento} %reduzir para uma página
``Ignorantes somos nós que não podemos alcançar tão longe como a
...
pragmáticos envolvidos, são elementos que convergem para o nome de
Luiz Gama como autor.
% Há outros componentes que levam ao seu nome,
%contudo, salvo indicações anotadas no texto, a tarefa poderá ser
%desenvolvida melhor em outro espaço. Por ora,
Lembremos que Gama era
acusado de injuriar o juiz Rego Freitas, crime pelo qual iria a
julgamento no Tribunal do Júri de São Paulo no final do ano de 1870. Assim,
...
impensável fazê-lo e permanecer atuante no foro da capital, sobretudo ao
se considerar o momento delicado que adveio com sua recente demissão
...
artista. Embora o ``obscuro comerciante'' indique que só
...
bandeira que desagravava a outras pessoas --- inclusive a si
próprio! ---, além dos ``infelizes Baylão, Lyrio, Beraldo e outros, que
por serem desprotegidos e mais pobres do que o sr.\,dr.\,Felicio, não têm
...
jurisdição. Apresentando-se ora como um simples ``comerciante'',
...
Porque, ainda que dissesse ser um dos ``homens do balcão, e não da pena,
da palavra e da espada'', era esse mesmo ``obscuro comerciante'' que citava
a \textnormal{Eneida} de Virgílio, o \textnormal{Quixote} de Cervantes e as \textnormal{Fábulas} de La Fontaine. Gama, em outras passagens, também citaria o poeta romano, o
poeta castelhano e o poeta francês. Isso porque o ``obscuro comerciante''
não dizia ser homem nem da pena, nem da palavra\ldots{} Tal paradoxo
...
``obscuro comerciante'' discutia tipificações penais e conhecia a
legenda de Bártolo de Sassoferrato, autoridade indiscutível em direito
romano. Ao fim, o ``obscuro comerciante'' defendia que, ``cego, de
...
os labores, e em que as ideias sobre os direitos do cidadão têm
...
afazeres de sua profissão venha à imprensa clamar contra um dos mais
...
fracos e pobres, para revelar a coragem que a \emph{alguém fugiu em
...
bravatas de um Herodes de comédia,\footnote{ Referência a Herodes \textsc{i}
...
lisonjeia-lhe o amor próprio elevado à estultice\footnote{ Estupidez.}
...
vítima foi todo espontâneo, porque nem todos têm a \emph{coragem} e
...
\chapter{Ainda a prisão do artista Leal\footnote{\emph{Correio Paulistano} (\textsc{sp}), A Pedido, Ao Público, 17 de julho de 1870, p.\,3.}} % bruno: cap.8

\begin{didascalia}
O primeiro artigo causou uma celeuma. Um advogado famoso saiu em
...
dois textos. Traz de seu arquivo uma antiga
opinião de Theodoro Xavier, o advogado famoso que dois anos
depois viria a ser nomeado presidente da província de São
Paulo, sobre o juiz Felicio. O autor apontava a contradição.
...
juiz Felicio, por sua vez, o ``obscuro comerciante'' reservava
...
sátira pungente que morderia as vaidades do juiz. Felicio seria então
...
sobretudo àqueles que o denunciaram ao juiz do comércio, o ``obscuro
comerciante'' aconselhava que, ainda que tivessem razão, nunca mais
...
rei da Judeia e Galileia. Porém, alterando
  ligeiramente a ilustração do texto precedente, em vez de ``Herodes de
  comédia'' inscreveu ``Herodes (\ldots{}) ridículo''. O sentido, como se vê,
  vai na mesma direção: caricaturar a imagem do juiz Felicio. A
...
inchar como a rã da fábula.\footnote{ O autor agregou mais um elemento
  ...
  interessantes implicações. Era o fabuloso caso da rã que, por
  ...
  também continha uma lição moral para o caso concreto. Advertia os
  ex-companheiros do artista Leal, embora
  reconhecendo razão em parte da demanda, para o fato de que
...
lábios as solas da \emph{estátua de Minerva} representando de %representando de Herodes?
Herodes.\footnote{ Estabelecendo um contraste bizarro entre a estátua e
  ...
  julgamento, e por outro, a crueldade de Herodes \textsc{i}.}
...
--- quae tans lota tulerunt sacula, judice?} --- entretanto, o ilustrado %falta tradução
...
um seu colega, e no \emph{Diário de hoje}\footnote{ \emph{Diário de S.\,Paulo} (\textsc{sp}), Publicações Pedidas, 16 de julho de 1870, p.\,2.}
...
\emph{processado como tem sido os infelizes} Baylão,\footnote{ Pascoal
  ...
  volume, ``Caso virgem {[}réplica{]}.''} Lyrio, Beraldo e outros,
que por serem desprotegidos e mais pobres do que o sr.\,dr.\,Felicio, não
têm por isso abalado, mais do que o \emph{erudito} réu-juiz, a
...
***\footnote{ O artigo, assim como todos os grifos, confere exatamente
  ...
  São Paulo} (\textsc{sp}), Publicações Pedidas, 19 de novembro de 1869, p.\,2.}
\end{flushright}
\end{quote}

A este artigo o sr.\,dr.\,Felicio respondeu dando uma satisfação pela
...
decisão, porque isto compete aos advogados e não a nós que nos dedicamos
...
ver que as falências de José Sptzler, Henrique Roger, Gaspar Buhr, e %Sptzler mesmo?
...
\chapter{Ainda a prisão do artista Leal\footnote{\emph{Correio Paulistano} (\textsc{sp}), A Pedido, Ao Público,
  24 de julho de 1870, p.\,3.}} % bruno: cap.9

\begin{didascalia}
O ``obscuro comerciante'' volta a acusar o juiz Felicio da
...
pela vaidade. Alguém que, no que cabia ao ``obscuro comerciante'',
...
detenção.\footnote{ O decreto nº 737, de 25 de novembro de 1850, regulava a ordem
  ...
  lia: ``Para a concessão do mandado de detenção especial é essencial'', §\,1º, ``Prova literal da dívida''. Era fora de dúvida, portanto, segundo o
  processo no juízo comercial, que para se proceder com a detenção do
  artista Leal o juiz estava obrigatoriamente vinculado a uma prova
...
juiz\footnote{ Esse é um dentre tantos indícios estilísticos que
  ...
  ``Cousas do sapientíssimo sr.\,dr.\,Felicio''.} expediu uma ordem
...
artigo.\footnote{ Cf. \emph{Diário de São Paulo} (\textsc{sp}), Publicações Pedidas, 19 de novembro de 1869, p.\,2.}
...
Em o nosso primeiro artigo chamamos para o fato a atenção dos srs.\,drs.\,promotor público e juiz de direito da comarca,\footnote{ O título do
  artigo, inclusive, é ``Para o sr.\,dr.\,juiz de direito ver''.}
...
responsabilidade.\footnote{ Respectivamente, o art. 37 do Código
  ...
  peita, concussão, suborno, ou qualquer outro de responsabilidade''. O §\,4º, ato contínuo, ordenava que o promotor tinha atribuição para
...
Tocamos nesta questão não porque pretendamos apontar aos srs.\,drs.\,promotor público e juiz de direito da comarca a lei que lhes impõem
...
empoleirados\footnote{ Que subiu no poleiro, espécie de vara onde aves,
  ...
  autoridade.} em posições indevidas, e que só têm poder a exercer
contra aqueles que não são favorecidos da fortuna nem da proteção de
pretensiosos potentados.
...
posição; e que a impunidade dos pequenos crimes não leve o sr.\,dr.\,Felicio à prática de maiores atentados.\footnote{ Mais uma vez o autor
  ...
  sob a jurisdição do juiz Felicio Ribeiro Camargo.}
...
ir policiar a festa de Pirapora,\footnote{ A tradicional festa do Bom
  ...
  nome, Bom Jesus de Pirapora, localizada a cerca de 50\,km da
  ...
  presentes em alguma medida ao tempo da escrita do artigo, constituem parte da riqueza do cenário cultural do povo
...
da ilha do Carvalho.\footnote{ Refere-se ao Combate da Ilha da \label{ilha}
...
começou a regular e policiar o modo de passagem.\footnote{ Indiscutível
  ...
  Considerando a ilha de Baratária uma paródia do poder, onde o
  ...
  Junior, ``Sancho Pança, governador: utopia e história em Dom
  Quixote'', \textit{Diálogos -- Revista do Departamento de História e do Programa
...
\begin{didascalia}
O ``obscuro comerciante'', que firmou os três textos
...
cauda, roçando pelo tinteiro, e borrou'' os papéis e, por derivação de
...
comerciante'', que lia e citava Virgílio, Cervantes e La Fontaine,
o escrivão constrói sua peça sobre o libreto \textnormal{Orfeu na roça}, do
...
``terrível mania revogatória'' e revogaria artigo do Código
...
normativo. \textnormal{Pari passu} à sátira, o nosso Kikiriki discutia os
...
gerada por novação e a exceção discutida entre o excepto e o excipiente.
Ao fim e ao cabo, o que é uma aula de sátira é também uma classe de
direito.
\end{didascalia}

\section{Protocolo das audiências do sr.\,Mademe de Souza, juiz transformado em
...
\footnotetext{ A referência provém da ópera \emph{Orfeu na roça}, do
  ...
  Afro citaria em outra passagem --- ``Eu não sou juiz de paz?!
  Revogo a Constituição!''. Silvia Cristina Martins de Souza, ``Um
  Offenbach tropical: Francisco Correa Vasques e o teatro musicado no
  Rio de Janeiro da segunda metade do século \textsc{xix}'', \textit{História e
...
\emph{depois do que} daria a palavra às partes, para dizerem afinal, e
...
Processo''.\footnote{ Isto é, do Código de Processo Criminal. O ``obscuro
  comerciante'' citava um processo específico, que teve lugar no juízo do
  ...
  art. 208 determinava que: ``Não comparecendo o delinquente na audiência
...
feito de \emph{severamente puni-lo com todo rigor da lei}.\footnote{ O
  pseudônimo que assina esse artigo, substituindo o 
  ``obscuro comerciante'', deve ter, além dos demais elementos anotados
  abaixo, algo a ver com o vilipendiado ``escrivão do feito'' mencionado
...
Carvalho.\footnote{Para o Combate da Ilha da Redenção, cf. n.\,\ref{ilha}, p.\,\pageref{ilha}. A menção à ilha do Carvalho, que também se lê no texto anterior, parece se ligar
...
regulamento.\footnote{ Respectivamente, art. 426 do Código Comercial
  ...
  seriam ``também julgados em conformidade das disposições do Código e
  ...
  riscos e fretamentos''.} O bem elaborado da sentença, já quanto a
...
no protocolo,\footnote{ Afora a beleza da imagem literária, a um só
  ...
  argumento do juiz Felicio, que dizia não querer manchar a sua toga.} do qual fielmente extraí
as certidões supra, eu,

\begin{flushright}
\textsc{o escrivão thadeu de kikiriki}\footnote{ Escapam as razões exatas que
  ...
  de conteúdo, a substituição parece ter sido uma opção estética para
  ...
  ``No álbum do sr.\,capitão João Soares'', poema que integra seu
  ...
  Lígia Fonseca Ferreira, ``Luiz Gama autor, leitor, editor:
  revisitando as \textit{Primeiras trovas burlescas} de 1859 e 1861'',
  \textit{Estudos Avançados}, vol.\,33, nº 96, mai.-ago., 2019, pp. 109--135,
...
\begin{didascalia}
``Pouco a pouco vai se introduzindo neste tribunal o uso criminoso
...
poderia dizer aos cidadãos de São Paulo que não confiassem nem na
...
próximo júri que aquele que então exerceria a presidência do Tribunal
...
botões e vendido a José Worms, e por este fato pronunciado na delegacia
...
um par de botões de camisa com pedras de brilhantes, e vendido a José
...
este fato constitui crime o crime de estelionato!}\ldots{}'' %constitui crime o crime?
...
A luneta sem vidro e a flauta que ele a vendeu.\footnote{ Escapam os %a fllauta que a ele vendeu?
...
será bem-vinda à própria estrutura da \textnormal{Obra completa}. Por ora,
...
Furtado'', artigo único desse tópico, contrasta, por um lado, com a
ebulição dos tempos do \emph{Radical Paulistano}, onde um debate sobre
...
distintos srs.\,drs.\,Américo Braziliense\footnote{ Américo Braziliense \label{americo}
  ...
  republicano.} e Ferreira de Menezes\footnote{ José Ferreira de\label{menezes}
...
\textsc{américo de campos}\footnote{ Américo Brazilio de Campos (1835--1900),\label{brazilio}
...
frente. A despeito de tamanhas contrariedades, e no fervor da
...
Campos,\footnote{Ver n.\,\ref{brazilio}, p.\,\pageref{brazilio}.} ambos republicanos, vai transcrever a maior parte dos
...
sobre causas pendentes.''\footnote{ Gama demonstra, com isso, ter acesso
  a papéis reservados, quiçá sigilosos, que continham a comunicação
...
Americo Braziliense de Almeida Mello\footnote{Ver n.\,\ref{americo}, p.\,\pageref{americo}.}
...
senão os produzidos pelas joias de iniciação, mensalidade dos sócios,
...
\begin{flushright}
\textsc{américo de campos}\footnote{Ver n.\,\ref{brazilio}, p.\,\pageref{brazilio}.} (1º Vig:.)\footnote{ 1º Vigilante.}

\textsc{luiz gama} (2º Vig:.)\footnote{ 2º Vigilante.}

\textsc{j. ferreira de menezes}\footnote{Ver n.\,\ref{menezes}, p.\,\pageref{menezes}.} (Orad:.)\footnote{ Orador.}
...
de abril do dito ano, nesta imperial cidade de São Paulo, em a sala das
...
sr.\,dr.\,juiz de direito com os heroicos e generosos soldados
brasileiros''.}
\end{didascalia}
...
direito com os heroicos e generosos soldados brasileiros.
\end{quote}
...
aceita pela nossa Lei nº 2.040 de 28 de setembro de 1871, art. 4º, §\,5º;\footnote{ A primeira parte do \emph{caput} do art. 4º da Lei do
...
3º, art. 123; Coelho da Rocha\footnote{ Manuel Antonio Coelho da Rocha
  ...
  político, advogado e historiador do direito.}, Dit. Cit. 76, §\,3º).\footnote{ A referência indicada é exata. O trecho citado por Gama
...
Pilatos\footnote{ Pôncio Pilatos foi governador da Judeia (26--36\,a.C.) e
...
do juiz de órfãos (Lei nº 2.040 de 28 de setembro de 1871, art. 4º, §§\,2º e 3º).\footnote{ Trata-se da conhecida Lei do Ventre Livre. O art.
...
é nobre missão do juiz. --- Senador Pimenta Bueno.\footnote{Ver n.\,\ref{bueno}, p.\,\pageref{bueno}.}
...
Que eu Minos\footnote{ Na mitologia grega, Minos era filho de Zeus e da
  ...
  {[}\textsc{iii}{]}, 13 de abril de 1868; ``Juízo Municipal -- Questão Fryer \&
  Jones'', 17 de outubro de 1872; e ``Carta a Ferreira de Menezes'', 01 de fevereiro de 1881.}
...
Ao segundo quesito também respondo negativamente: o pecúlio que a lei (§\,2º, cit.) se encarregou de definir é o valor da indenização pela
...
Mais dois pareceres, no mesmo sentido, foram escritos pelos exmos. srs.\,conselheiro Ramalho\footnote{ Joaquim Ignacio Ramalho (1809--1902),
...
estampa\footnote{ Infelizmente, de tudo o que pesquisei não encontrei o
  ...
  violentas.} elucubrações, e fa-lo-ei com pervicácia\footnote{ Mesmo
...
vastidão fecunda os cuidados da magna Pauliceia: o primeiro é o jovem
...
\textsc{américo de campos}\footnote{Ver n.\,\ref{brazilio}, p.\,\pageref{brazilio}.}
...
\textsc{ferreira de menezes}\footnote{Ver n.\,\ref{menezes}, p.\,\pageref{menezes}.}
...
posteriores que viriam a público contestar a opinião de Gama, Ferreira
...
estrangeira contra o Brasil, como os defensores do imperador --- inclusive
...
(\textsc{sp}), no mês de abril daquele mesmo ano. Gama, Ferreira de Menezes e
