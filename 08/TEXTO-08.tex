...
\chapter{Questão forense\footnote{In: \emph{A Província de S.\,Paulo} (\textsc{sp}), Seção Jurídica, 14/10/1880, pp. 1--2.}}
...
\chapter{Fato grave -- Jaú\footnote{In: \emph{A Província \label{jau}
...
\chapter{Contraprotesto\footnote{In: \emph{A Província de S.\,Paulo} (\textsc{sp}), Seção Particular, Itatiba, 04/01/1881, p. 2.}}
...
\chapter{Exemplo de piedade, I\footnote{In: \emph{Gazeta de S.\,Paulo} (\textsc{sp}), Ineditoriais, 05/02/1881, p. 3. Embora sinalize que seja
...
\chapter{Como se conta a história\footnote{In: \emph{Gazeta de S.\,Paulo} (\textsc{sp}), Ineditoriais, 07/02/1881, p. 2. A marcação numeral ``15--1'', que vinha ao final do texto,
...
\part{O ás da abolição: carta de Luiz Gama a Ferreira de Menezes}
...
\section{é mais um mote para uma carta}
...
\chapter{Retificação necessária\footnote{In: \emph{Gazeta de S.\,Paulo} (\textsc{sp}), Ineditoriais, 14/01/1881, p. 3.}}
...
\chapter{Ao governo -- é grave\footnote{In: \emph{Gazeta de S.\,Paulo} (\textsc{sp}), Ineditoriais, 15/01/1881, p. 3.}}
...
\chapter{Carta a José Maria Lisboa\footnote{In: \textit{Almanaque literário de S.\,Paulo para o ano de 1881}, s/d. ``Uma carta''.}}
