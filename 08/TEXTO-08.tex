...
\chapterspecial{A deportação dos «cafetões» II}{Habeas-corpus\footnote{In: \emph{A Província de S.\,Paulo} (\textsc{sp}), Seção Livre, 31/01/1880, pp. 1--2.}}
\index{habeas-corpus}
...
manda a Regência provisória, em nome do Imperador,\index{Pedro \textsc{i}}\footnote{Como essa
