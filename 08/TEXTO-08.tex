...
\chapter{Carta a Lúcio de Mendonça\footnote{In: Biblioteca
...
--- e, entre múltiplas expertises, torna-se um dos mais importantes %it. expertise?
...
Era dotada de atividade. Em 1837, depois da Revolução do dr.\,Sabino,\footnote{A ``revolução do dr.\,Sabino'', também conhecida por \label{sabinada}
...
Estive então preso 39 dias, de 1º de julho a 9 de agosto.\footnote{Ver,
  nesse volume, ``Carta -- Recreio D'Amizade''.} Passava os dias lendo %Cf. nome
...
na igreja matriz do Sacramento, da cidade de Itaparica.\footnote{Ver nota \ref{mennucci} à página \pageref{mennucci}.}

É filho natural de uma negra, africana livre,\footnote{Ver nota \ref{livre} à página \pageref{livre}.} da Costa de Mina, de nação
Nagô,\footnote{Ver nota \ref{nago} à página \pageref{nago}.} de
nome Luiza Mahin,\footnote{Ver nota \ref{mae} à página \pageref{mae}.} pagã: recusou esta sempre
...
não tiveram efeito.\footnote{Ver nota \ref{males} à página \pageref{males}.} Em 1837, depois da revolução do dr.\,Sabino,\footnote{Ver nota \ref{sabinada} à página \pageref{sabinada}.}
...
\emph{casa de dar fortuna},\footnote{Ver nota \ref{fortuna} à página \pageref{fortuna}.} em 1838, fora posta em
prisão, e que tanto ela como os companheiros desapareceram. Era opinião
...
alferes Antônio Pereira Cardozo,\footnote{Ver nota \ref{cardozo} à página \pageref{cardozo}.} o mesmo que, há oito
...
Souza Aranha, pai do sr.\,conde de Três Rios.\footnote{Ver nota \ref{egydio} à página \pageref{egydio}.} Depois de o
...
Furtado de Mendonça,\footnote{Ver nota \ref{fmfm} à página \pageref{fmfm}.} que por longos anos exerceu na capital de S.\,Paulo
...
polícia, e assinada pelo dr.\,Vicente Ferreira da Silva Bueno,\footnote{
  Ver nota \ref{bueno} à página \pageref{bueno}.} que, por este e
...
\hfill\ S.\,Gonçalo, Minas,\footnote{São Gonçalo do Sapucaí é um município
...
\medskip
\hfill\emph{Spartacus}

\chapter{A questão de raças\footnote{In: \emph{Gazeta do Povo}
  (\textsc{sp}), Publicações Pedidas, 18/07/1880, p. 2; \emph{A Província de S.
  Paulo} (\textsc{sp}), Seção Particular, 20/07/1880, p. 2; e também na
...
Agora, no seio do parlamento, perante a nação brasileira, o sr.\,dr.\,Moreira de Barros, deputado paulista e ex-ministro do imperador, disse o
seguinte:
...
\hfill\ S. Paulo, 17 de julho de 1880
...
\markboth{Ao Exmo Sr.\,Conselheiro Presidente\ldots{}}{}
...
\hfill\textsc{john brown}\footnote{Ver nota \ref{brown} à página \pageref{brown}}
...
\chapter{A lei e os «cafetões»\footnote{In: \emph{A Província de S.
  Paulo} (\textsc{sp}), Seção Livre, 21/01/1880, p. 2.}}
...
\hfill\emph{Um constituinte constituído}
...
Tendo declarado ao exmo.\,sr.\,dr.\,Sebastião José Pereira\footnote{Ver nota \ref{sjp} à página \pageref{sjp}.}
...
\hfill\ S. Paulo, 20 de janeiro de 1880
...
costumes, o estado, a religião, e até a própria monarquia, segundo a %Estado em c.a.?
...
20 de setembro de 1871, art. 13).\footnote{Ver nota \ref{art13}, acima.}
...
M. o Imperador, os delinquentes são \emph{caftans}\footnote{Cafetões.} ou
...
Se o parágrafo oitavo do artigo 15 da Constituição\footnote{Ver nota \ref{art15}, acima.} é um sagrado
...
\hfill\ S. Paulo, 24 de janeiro de 1880
...
\pagebreak
\hfill\ Tribunal da Relação do Distrito

\hfill\ Sessão extraordinária do dia 20 de janeiro de 1880
...
\hfill\ S. Paulo, 17 de janeiro de 1880
...
tolher}, exceptuando-se \emph{por ora} das disposições deste parágrafo %excetuando-se?
...
conservar por algum tempo, \textsc{em casos gravíssimos}, incomunicáveis os %cf. versal
...
com ódio para com ele, porque, tendo consumido o pecúlio\footnote{
  Patrimônio, quantia em dinheiro que, por lei (1871), foi permitido ao
  escravizado constituir a partir de doações, legados, heranças e
  diárias eventualmente remuneradas.} de 400\$ de uma escrava do sr.\,dr.\,Clímaco Barbosa,\footnote{Clímaco Barbosa (1839--1912), natural de \label{climaco}
...
\hfill\ S. Paulo, 25 de setembro de 1880

\hfill\textsc{l. gama.}

%manter esse cap. como section do anterior?
\chapter{Luiz Gama ao público {[}réplica{]}\footnote{In:
  \emph{A Província de S. Paulo} (\textsc{sp}), Seção Livre, 26/09/1880, p. 2.}}
...
contudo, do lugar que a luta abolicionista vinha conquistando
...
Constitucional?\footnote{Ver nota \ref{art15}, à página \pageref{art15}.}
...
sr.\,conselheiro d.\,F. B. da Silveira,\footnote{Ver nota \ref{balthazar} à página \pageref{balthazar}.} declarou, para resguardo de sua opinião:
...
Lei de 26 de janeiro de 1818; conta 62 \textsc{anos de existência}, e \emph{não} %cf. c.a.
...
Juiz --- o exmo.\,sr.\,dr.\,Bellarmino Peregrino da Gama e %Um pouco confuso
...
Pretendê-las é despertar cautelas de segurança; auxiliá-la, é dar prova %Pretendê-la?
...
ruína do estado: tal é o terrível boato, sinistramente propalado em %Estado?
...
ser retirado da casa de seu senhor, e depositado. {[}!!!{]} %parênteses em vez de colchete?
...
\textsc{das causas em favor da liberdade} %Pensar na disposição dessa frase.
...
\chapter{Questão jurídica I\subtitulo{Subsistem os efeitos manumissórios da
...
terror, seus meios a violência, seu fim a negação direito. Os fatos têm %negação do direito?
...
município de Campinas, o exmo.\,sr.\,desembargador Faria,\footnote{Ver nota \ref{jff} à página \pageref{jff}.} digno procurador da Coroa, em enérgico discurso,
...
direito drs.\,Gama e Mello\footnote{Ver nota \ref{bellarmino} à página \pageref{bellarmino}.} e Gonçalves
...
foi decretada para execução dos Tratados de 1815 e 1817, ``vigentes; e os %aspas sem fechamento
...
conselheiros de estado, dos senadores e deputados, que dispõem da %Estado?
...
contrário.\footnote{A citação reforça mais uma aspecto da erudição de
  ...
  escravidão. Sobre o projeto, cf. Anais do Parlamento Brasileiro, %Anais?
  Camara dos Srs.\,Deputados, sessão de 1848, vol. 2, p. 325.} %Câmara?
\end{quote}
...
Em 1848, \textsc{o governo liberal}, mais no intuito de proteger aos donos de %cf. c.a.
...
1831),\footnote{O comentário é de Gama.} que contraria de frente os %É necessária essa observação? Todos os comentários do Bruno têm sido feitos em nota de rodapé... 
...
assim como a liberdade dos escravos ``apreendidos no alto mar ou na %aspas sem fechamento
...
\chapter{Questão jurídica II\subtitulo{O escravo que requer e é admitido a
...
compromisso que assumiu no célebre artigo} ``Questão de Liberdade'', \emph{ainda no início de sua carreira. O cocheiro Lima tinha nome; não era o} ``Vira-Mundo'', \emph{apelido que a imprensa insistia em usar. Era um
...
\hfill\ S.\,Paulo, 23 de abril de 1881

\hfill\textsc{luiz gama}

\chapter{{[}Resposta ao Sr.\,F\ldots{}{]}\footnote{Lusus, in: \emph{A Província de S. Paulo} (\textsc{sp}), Seção Livre, O vice-consulado de Portugal em S. Paulo, 17/03/1881, p. 1.}}
...
processo, por isso o título} ``O seu a seu dono''. \emph{Para Gama, o
...
\chapter{Despertador moral -- \textsc{i}\footnote{In: \emph{A Província de
...
\medskip
\hfill\emph{Leão da Torre de S. Bento}

\chapter{Despertador moral -- \textsc{ii}\footnote{In: \emph{A Província de
...
\medskip
\hfill\emph{O Leão da Torre de S. Bento}

\chapter{Despertador moral -- \textsc{iii}\footnote{In: \emph{A Província
...
\chapter{Despertador moral -- \textsc{iv}\footnote{In: \emph{A Província de
...
na promotoria, no judiciário\ldots{} --- sobre o crime do palacete da rua S.
...
\chapter{Exemplo de piedade, \textsc{i}\footnote{In: \emph{Gazeta de S.
  Paulo} (\textsc{sp}), Ineditoriais, 05/02/1881, p. 3. Embora sinalize que seja
...
\chapter{{[}Réplica do misericordioso Almeida{]}\footnote{In:
  \emph{Gazeta de S. Paulo} (\textsc{sp}), Ineditoriais, 06/02/1881, p. 3.}}
...
\hfill\emph{Francisco Martins de Almeida}

\section*{o comendador francisco martins de almeida ao público}
...
\medskip
\noindent\emph{Frei Chico Socó}

\chapter{Como se conta a história\footnote{In: \emph{Gazeta de S.
  Paulo} (\textsc{sp}), Ineditoriais, 07/02/1881, p. 2. A marcação numeral abaixo
...
\chapter{O promotor público da capital e o crime da rua de S. Bento\footnote{In: \emph{A
  Província de S. Paulo} (\textsc{sp}), Seção Particular, 08/02/1881, p. 2.}}
...
\medskip
\hfill\ S. Paulo, 6 de fevereiro de 1881

\hfill\emph{J. J. Cardoso de Mello Junior}\footnote{José Joaquim Cardoso de
  Mello Junior (1860--1948), nascido em São José do Barreiro (\textsc{sp}), foi
  advogado, promotor público, juiz de direito e chefe de polícia da
  província de São Paulo (1889).}
...
nunca tiveram escravos (\ldots{}), que não se corrompem, nem se vendem'' --- e
...
Espártacos,\footnote{Ver nota \ref{espartacos} à página \pageref{espartacos}.} que mataram o infeliz filho do fazendeiro Valeriano José
do Valle.
...
futuro: a Abolição. Chegaria o dia, Gama imaginava, em que e os senhores
...
\hfill\ S.\,Paulo, dezembro de 1880
...
\section*{projeto para a extinção do elemento servil no império do brasil}
...
Sim! Sim! É mais um futuro Espártaco,\footnote{Ver nota \ref{espartacos} à página \pageref{espartacos}.} que segue caminho a sublimar-se pelo martírio, em
apoteose.
...
\hfill\textsc{proudhon}\footnote{O leitor mais detalhista pode ter reparado,
...
contava ``uma cena revoltante, horrorosa, cruel e infame (\ldots{}) praticada
...
O \emph{tempora}!\ldots{} O \emph{mores}!\ldots{}\footnote{``Ó, tempos!\ldots{} Ó,
...
sinalizam a não interferência no original, a palavra norte dos demais
...
\chapter{{[}Emancipação -- \textsc{ii}{]} à redação da “Província”\footnote{
...
\emph{sobretudo em relação ao desagravo que fez a José
...
\chapter{A emancipação -- ao pé da letra {[}\textsc{iv}{]}\footnote{
...
da deusa \textsc{preguiça}'', a Abolição poderia ser adiada} ad eternum\emph{,
...
Brown,\footnote{Ver nota \ref{brown} à página \pageref{brown}.} como
Espártacos,\footnote{Ver nota \ref{espartacos} à página \pageref{espartacos}.} como Lincoln,\footnote{Abraham Lincoln (1809--1865) foi
...
\chapter{Limeira -- ao Sr.\,Luiz Gama\footnote{In: \emph{A Província de S. Paulo} (\textsc{sp}),
...
\chapter{Ao governo -- é grave\footnote{In: \emph{Gazeta de S.
  Paulo} (\textsc{sp}), Ineditoriais, 15/01/1881, p. 3.}}
...
\medskip
\hfill\ S. Paulo, 14 de janeiro de 1881

\hfill\textsc{luiz gama}

\chapter{Ao governo -- é grave {[}réplica{]}\footnote{In:
  \emph{Gazeta de S. Paulo} (\textsc{sp}), Ineditoriais, 16/01/1881, p. 3.}}
...
\medskip
\hfill\ S. Paulo, 15 de janeiro de 1881

\hfill\textsc{sebastião raymundo ewerton}

\hfill\ Capitão

\chapter{Ao governo -- é grave {[}\textsc{ii}{]}}
...
\medskip
\hfill\ S. Paulo, 21 de janeiro de 1881

\hfill\textsc{luiz gama}

\chapter{Aos paulistas\footnote{In: \emph{Gazeta do Povo} (\textsc{sp}),
...
\hfill\textsc{dr.\,clímaco barbosa}\footnote{Ver nota \ref{climaco} à página \pageref{climaco}.}
...
Essa carta acompanhou a célebre poesia --- \textsc{primus inter pares}\footnote{
...
Paço de S.\,Cristóvão!\ldots{}\footnote{Um dos locais de residência
  ...
  Corte de Lisboa ao Rio de Janeiro. Após a Independência do Brasil
...
Ilmo.\,Sr.\,José Hyppolito,\smallskip
...
Meu caro dr.\,Cerqueira César,\smallskip
...
em que viviam e ficaram na Cachoeira, distrito de Lorena,\footnote{A
  ...
  de Gama, conforme ele conta na \emph{Carta a Lúcio de Mendonça}.}
