...
não tiveram efeito.\footnote{\index{Levante dos Malês}Ver n. \ref{males}, p. \pageref{males}.} Em 1837, depois da \index{Sabinada}revolução do dr.\,Sabino,\footnote{Ver n. \ref{sabinada}, p. \pageref{sabinada}.}
...
mandões do liberalismo que do \index{Capitólio}Capitólio\footnote{Uma das sete colinas
...
Há mais de um ano a preta Brandina\index{Escravizados!Brandina}, maior de 70 anos, escrava do
...
\markboth{A deportação dos «cafetões» II}{}
...
\hfill\textsc{sebastião josé pereira}\footnote{Sebastião José Pereira (1834--1881),
  nascido em São Paulo (\textsc{sp}), foi advogado, juiz de direito e presidente
...
Refere o \emph{Jornal do Commercio} em sua gazetilha\footnote{Seção \index{Jornais!Jornal do Commercio}
...
Requereu Elisa\index{Libertandas!Elisa}, mulher branca, escrava do exmo.\,sr.\,dr. Camilo Gavião
...
idade --- \emph{uma Rio Branco}.\footnote{Referência à criança que já
  ...
  (1819--1880), então presidente do \index{Conselho dos Ministros}Conselho dos Ministros quando da
  assinatura da lei.}
...
Espártacos,\footnote{Ver n. \ref{espartacos}, p. \pageref{espartacos}.} que mataram o infeliz filho do fazendeiro Valeriano José
do Valle.
...
Li nesta folha uma notícia, tirada do \emph{Colombo}, jornal onde peleja \index{Jornais!Colombo}
...
\hfill\textsc{proudhon}\index{Proudhon, Pierre-Joseph}\footnote{O leitor mais detalhista pode ter reparado,
  com razão, que esse Proudhon não tinha nada a ver com José do
...
Brasil --- da Insurreição Praieira (1848--1850) à Revolta do Vintém\index{Revolta do Vintém}
...
matas, terá \index{Silveira, Pedro Ivo Veloso da}Pedro Ivo\footnote{Pedro Ivo Veloso da Silveira
  ...
  \index{Poder Moderador}Poder Moderador --- peça-chave da monarquia brasileira ---, o voto livre,
...
quando redator da \index{Jornais!Democracia}\emph{Democracia},\footnote{O jornal
  ...
  \emph{O Cabrião}\index{Jornais!O Cabrião} (1866--1867), \emph{Democracia} surge como órgão
...
Paço de S.\,Cristóvão!\ldots{}\footnote{Um dos locais de residência
  ...
  Corte de Lisboa ao Rio de Janeiro. Após a Independência do Brasil e 
  até a Proclamação da República, foi a residência da família
...
\chapterspecial{Católico, mas escravista}{Carta ao Dr.\,Cerqueira César\footnote{In: Coleção Emanuel
