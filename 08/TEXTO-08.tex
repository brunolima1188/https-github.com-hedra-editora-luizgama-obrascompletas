...
À nobre província de São Paulo, que hoje o estima entre os seus melhores
...
mesmo ano de 1861, voltando a São Paulo, e estando em comissão do
...
ou dez anos, sendo fazendeiro no município de Lorena, na província de São Paulo, no ato de o prenderem, por haver matado à fome alguns escravos em
...
sapateiro, voltou para a casa de Cardoso, na cidade de São Paulo, à rua
...
Furtado de Mendonça,\footnote{Ver n. \ref{fmfm}, p. \pageref{fmfm}.} que por longos anos exerceu na capital de São Paulo\index{Faculdade de Direito de São Paulo}
...
escravos. Sei que teve a cabeça posta a prêmio por fazendeiros de São Paulo, e tempo houve em que não poderia ir da capital à Campinas sem
risco de vida.

Há 8 ou 10 anos, foi Luiz Gama à barra do júri de São Paulo processado
...
nobre vulto de Luiz Gama destacou-se a toda à luz. Estava reunido em São Paulo, num palacete da rua de Miguel Carlos, em 2 de julho de 1873, o
...
hoje em São Paulo um advogado de muito crédito e um cidadão
...
\chapter{A questão de raças\footnote{\emph{Gazeta do Povo}
  (\textsc{sp}), Publicações Pedidas, 18 de julho de 1880, p. 2; \emph{A Província de São Paulo} (\textsc{sp}), Seção Particular, 20 de julho de 1880, p. 2; e também na
  \emph{Gazeta da Tarde} (\textsc{rj}), Noticiário, 27 de julho de 1880, pp. 3--4.}}
\index{periódicos!Gazeta do Povo (\textsc{sp})}
\index{periódicos!A Gazeta da Tarde (\textsc{rj})}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
nem as do chefe conservador de São Paulo da parte de seus
correligionários.
...
\index{Marques, Abílio Aurélio da Silva}
  ...
  de São Paulo} (1875), foi proprietário da \index{livraria Civilização}Livraria Civilização e\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\emph{Gazeta de São Paulo} (\textsc{sp}), Ineditoriais, 11 de janeiro de 1881, p. 3.}}
\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
...
\chapter{A lei e os «cafetões»\footnote{\emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 21 de janeiro de 1880, p. 2.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\chapterspecial{Emparedando o chefe de polícia}{O Exmo.\,Sr.\,Dr.\,chefe de polícia\footnote{\emph{A
  Província de São Paulo} (\textsc{sp}), Seção Livre, 21 de janeiro de 1880, p. 2.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\chapter{A deportação dos «cafetões»\footnote{\emph{A Província
  de São Paulo} (\textsc{sp}), Seção Livre, 23 de janeiro de 1880, p. 2.}}
  \index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\chapterspecial{A deportação dos «cafetões» II}{Habeas-corpus\footnote{\emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 31 de janeiro de 1880, pp. 1--2.}}
\index{habeas-corpus}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
1822).\footnote{A primeira parte da citação --- até a expressão
  ...
  \emph{A Província de São Paulo} para a eventualidade de Gama ter
...
\chapterspecial{Escravidão e direito, ou porque sou abolicionista sem reservas}{Questão forense\footnote{\emph{A Província de São Paulo} (\textsc{sp}), Seção Jurídica, 14 de outubro de 1880, pp. 1--2.}}
...
corrente,\footnote{Cf. \emph{A Província de São Paulo} (\textsc{sp}), Noticiário,
...
\chapterspecial{Africanos livres presos como escravos}{Fato grave – Jaú\footnote{\emph{A Província \label{jau}
  de São Paulo} (\textsc{sp}), Seção Livre, Foro da Capital, 20 de outubro de 1880, p. 2.}}
\index{africanos livres}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\emph{Gazeta da Tarde} (\textsc{rj}),
  ...
  ontem, em São Paulo, o artigo que vai em seguida. Acometido há quatro
...
\chapterspecial{Terrorismo judiciário}{2ª vara cível\footnote{\emph{A Província de São Paulo}
...
Relação.\footnote{Isto é, Camilo Gavião Peixoto, a um só tempo juiz e
  ...
  desembargador do Tribunal da Relação de São Paulo.}
...
67.\footnote{Os desembargadores de Ouro Preto decidiam, em síntese,
  ...
  por um juiz em São Paulo, Umbellina\index{pessoas defendidas por Gama!Umbellina}, a libertanda que os
...
outubro de 1850?\footnote{\emph{A Província de São Paulo} (\textsc{sp}),
...
heroica província de São Paulo e avultava entre os chefes prestigiosos do
...
\chapterspecial{Desfazendo as ficções do direito}{Contraprotesto\footnote{\emph{A Província de São Paulo} (\textsc{sp}), Seção Particular, Itatiba, 4 de janeiro de 1881, p. 2.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
deste?\footnote{\emph{Gazeta de São Paulo} (\textsc{sp}), Ineditoriais,
...
\index{Tribunal do Júri}\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
Acabo de ler duas biliosas parlandas:\footnote{Falatório, palavreado,
  discussão acalorada.} uma da \textit{Gazeta de São Paulo} e outra da
...
\chapterspecial{Tranquilo dentro do caos}{Resposta ao Sr.\,F\ldots{}\footnote{Lusus, in: \emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, O vice-consulado de Portugal em São Paulo, 17 de março de 1881, p. 1.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\chapterspecial{A colônia portuguesa em São Paulo}{O seu a seu
...
\chapterspecial{Chibata aos pobres, incenso aos ricos}{É de admirar\footnote{\emph{A Província de São Paulo}
...
\chapterspecial{Uma história criminosamente bíblica}{Despertador moral I\footnote{\emph{A Província de
  São Paulo} (\textsc{sp}), Seção Livre, 24 de novembro de 1880, p. 1.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\chapterspecial{Um cadáver disputado}{Despertador moral II\footnote{\emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 25 de novembro de 1880, p. 1.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\chapterspecial{A farsa do atestado de óbito}{Despertador moral III\footnote{\emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 27 de novembro de 1880, p. 1.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\chapterspecial{Revirando as vísceras da medicina legal}{Despertador moral IV\footnote{\emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 1º de dezembro de 1880, p. 1.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
torturador, e chegou até a redação do jornal} Gazeta de São Paulo\emph{,
...
\chapterspecial{O misericordioso Almeida}{Exemplo de piedade, I\footnote{\emph{Gazeta de São Paulo} (\textsc{sp}), Ineditoriais, 5 de fevereiro de 1881, p. 3. Embora sinalize que seja
...
Gazeta de São Paulo\emph{, dá a sua versão da tortura imposta à parda
...
\emph{Gazeta de São Paulo} (\textsc{sp}), Noticiário, Mulher de pega e
...
\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
Ilustres srs.\,Redatores da \emph{Gazeta de São Paulo},
...
\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
A \emph{Gazeta de São Paulo} de hoje traz em seu noticiário uma local que
me é relativa.
...
escreveu.\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
...
\emph{Gazeta}.\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
...
\chapterspecial{Aplausos para o carrasco}{Máscara caída\footnote{\emph{Gazeta de São Paulo}
...
\chapterspecial{Tortura é tortura}{Como se conta a história\footnote{\emph{Gazeta de São Paulo} (\textsc{sp}), Ineditoriais, 7 de fevereiro de 1881, p. 2. A marcação numeral ``15--1'', que vinha ao final do texto,
...
\chapter{O crime da rua de S.\,Bento\footnote{\emph{A Província
  de São Paulo} (\textsc{sp}), Seção Particular, 6 de fevereiro de 1881, p. 2.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\index{periódicos!A Província de São Paulo (\textsc{sp})}
Ainda uma vez: não respondo ao anônimo da \emph{Província de São Paulo}
...
\emph{Gazeta da Tarde} (\textsc{rj}), 16 de dezembro de 1880. Também publicado em
  \emph{Gazeta do Povo} (\textsc{sp}), 14 de dezembro de 1880; e \emph{A Província de São Paulo} (\textsc{sp}), 18 de dezembro de 1880.}}
\index{periódicos!A Gazeta da Tarde (\textsc{rj})}
\index{periódicos!Gazeta do Povo (\textsc{sp})}
\index{Menezes, Ferreira de}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
pregadores de política positiva, solertes\footnote{No sentido de
  espertalhões, ardilosos.} redatores da \emph{Província de São Paulo};
...
Na cidade de São Paulo (esta mesma em que escrevo), em o ano de
...
\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
Venho da \emph{Gazeta de São Paulo}, onde deixei para ser impressa sua
...
alvo, com a chancela da redação da} Província de São Paulo\emph{,
...
\emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 4 de dezembro de 1880, p. 1.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\chapterspecial{Em defesa do jornalismo abolicionista}{Emancipação\footnote{\emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 15 de dezembro de 1880, p. 1.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
da} Província de São Paulo\emph{. Atento ao noticiário e aos colunistas
...
\chapterspecial{Chamada de atenção}{Limeira — ao Sr.\,Luiz Gama\footnote{\emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 21 de dezembro de 1880, p. 2.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\begin{quote}\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
\emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 12 de janeiro de 1881, p. 2. A
  réplica do comendador Joaquim Antonio de Paula Machado se lê em
  \emph{A Província de São Paulo} (\textsc{sp}), Seção Livre, 11 de janeiro de 1881, p. 2.}}
...
\chapterspecial{Em defesa dos escravizados Antonio e Raymundo}{Retificação necessária\footnote{\emph{Gazeta de São Paulo} (\textsc{sp}), Ineditoriais, 14 de janeiro de 1881, p. 3.}}
\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
...
\chapterspecial{O capitão torturador}{Ao governo — é grave\footnote{\emph{Gazeta de São Paulo} (\textsc{sp}), Ineditoriais, 15 de janeiro de 1881, p. 3.}}
\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
...
\index{periódicos!Gazeta de São Paulo (\textsc{sp})}
Com o título acima hoje traz a \emph{Gazeta de São Paulo} um artigo
...
São Paulo, a Bahia vos contempla!
...
\chapterspecial{Sabendo se excluir}{Meu nobre amigo\footnote{\emph{Gazeta da Tarde} (\textsc{rj}),
  ...
  democrata dirigiu à \emph{Gazeta do Povo}, de São Paulo, recusando,
...
a imortalidade; que a província de São Paulo está unida à de Minas
...
\chapterspecial{Uma carta tirada do baú}{Carta a José Maria Lisboa\footnote{\textit{Almanaque literário de São Paulo para o ano de 1881}, s/d. ``Uma carta''.}}
\index{periódicos!Almanaque literário de São Paulo}

\begin{resumo}
\emph{Gama escreve essa carta respondendo uma anterior, na qual é
solicitado pelo diretor do} Almanaque literário de São Paulo \emph{para
...
aceito \emph{Almanaque de São Paulo}\footnote{Publicação periódica anual
  com informações variadas da vida política, administrativa, comercial,
  cultural e literária. O \emph{Almanaque literário de São Paulo para o
...
\chapterspecial{Liberdade irrevogável}{O digno Sr.\,Dr.\,Guilherme Caetano da Silva\footnote{\emph{O Correio Paulistano} (\textsc{sp}), Seção Livre, 4 de novembro de 1881, p. 2.
  ...
  Jaboticabal. Cf. \emph{A Província de São Paulo} (\textsc{sp}), Seção Livre,
...
Silva,\footnote{Guilherme Caetano da Silva foi juiz municipal e de
  órfãos de Jaboticabal. Cf. \emph{A Província de São Paulo} (\textsc{sp}), Seção
...
\chapter{Carta a Hyppolito de Carvalho\footnote{\emph{A
  Província de São Paulo} (\textsc{sp}), Seção Livre, Casa Branca, 26 de abril de 1881, p.
  2.}}
\index{periódicos!A Província de São Paulo (\textsc{sp})}
...
Luiz Gonzaga Pinto da Gama, residente na cidade de São Paulo, vem perante
...
Cinco destes libertos conseguiram chegar a esta cidade de São Paulo; são
