...
\chapter{A deportação dos «cafetões» \textsc{ii} \subtitulo{Habeas-corpus\footnote{In: \emph{A Província de S.\,Paulo} (\textsc{sp}), Seção Livre, 31/01/1880, pp. 1--2.}}}
\markboth{A deportação dos «cafetões» \textsc{ii}{}\index{Habeas-corpus}
