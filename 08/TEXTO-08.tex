...
\chapter{{[}A deportação dos «cafetões» -- \textsc{ii}{]} \emph{Habeas-corpus
}\footnote{In: \emph{A Província de S. Paulo} (\textsc{sp}), Seção Livre,
  31/01/1880, pp. 1--2.}}
...
conselheiros de estado, dos senadores e deputados, que dispõe{[}m{]} da %Estado?
