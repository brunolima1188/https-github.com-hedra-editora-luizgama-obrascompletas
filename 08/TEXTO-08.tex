...
\chapter{Questão jurídica I\subtitulo{Subsistem os efeitos manumissórios da \label{questao}
...
\chapter{A colônia portuguesa em S.\,Paulo\subtitulo{O seu a seu
...
Usos tão bárbaros encerra!\footnotemark}{}\footnotetext{Citação adaptada dos versos de
  Virgílio (70--19 a.C.), no Livro \textsc{i} do poema épico Eneida:
...
moscas.\footnotemark}{}\footnotetext{Ditado moral que, de tanto ser repetido, se tornou
  de domínio público, muito embora possa ser atribuído a Sólon (638--558 a.C), poeta e estadista da Grécia Antiga.}
...
\hfill\textsc{j.\,j. cardoso de mello junior}\footnote{José Joaquim Cardoso de
...
violada, pedimos, reclamamos a manumissão dos desgraçados, surgem %surgem em vestidos?
...
salvação, depôs benigna, aquele náufrago do pudor\ldots{}
  ...
  --- Está feito! %Interrogação, ujma vez que a senhora pergunta?
