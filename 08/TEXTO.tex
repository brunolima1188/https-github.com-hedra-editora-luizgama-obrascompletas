...
\begin{didas}
\paragraph{Nota do organizador} \emph{A carta de Luiz Gama a Lúcio de Mendonça e a transformação dela,
...
11°).\footnote{Para a primeira parte do art. 18, Lei nº 2.033 de 1871,
  ...
  Assembleia Geral (\ldots{}) § 8º: Fazer Leis, interpretá-las, suspendê-las
...
Crim{[}inal{]}, art. 295).\footnote{Art. 12. ``Aos Juízes de Paz
  ...
  122, 123 c 124 do Código do Processo Criminal, obrigando-os a assinar
...
Constituição, \textsc{ninguém} poderá ser preso sem culpa formada, exceto nos
...
\hfill\textsc{camillo gavião peixoto}.\footnote{Camilo Gavião Peixoto (1830--1883)
...
\hfill\textsc{joão augusto de padua fleury}.\footnote{João Augusto de Pádua Fleury
...
\begin{itemize}
\item[---] Que o governo, o Poder Executivo, deportando a Grimberg e a Gomes
...
\item[---] Que o estrangeiro, no Brasil, não está em sua pátria: habita em
...
\item[---] Que os conselhos, senão os preceitos da boa higiene, prescrevem a
...
\item[---] Que a sociedade estava em sobressalto; as Leis desrespeitadas e
...
\item[---] Que a Constituição estabelece que ninguém seja preso sem culpa
...
\item[---] Que o dr.\,chefe de polícia, em vez das censuras que lhe eram feitas
  nas petições em discussão, tornara-se digno de louvores, pelo seu
  critério, energia e incontestável civismo (!!!);

\item[---] Que a prisão, em casos tais, independe de formalidades judiciárias;
...
\item[---] Que as inquirições secretas, em segredo de justiça, estão
...
de toda e qualquer Lei de} \textsc{proscrição},\footnote{Nesse caso, o mesmo
...
conservar por algum tempo, \textsc{em casos gravíssimos}, incomunicáveis os
...
\hfill\ O conde dos Arcos, etc., Palácio do Rio de Janeiro, em 23 de maio de
...
com ódio para com ele, porque, tendo consumido o pecúlio\footnote{
  Patrimônio, quantia em dinheiro que, por lei (1871), foi permitido ao
  escravizado constituir a partir de doações, legados, heranças e
  diárias eventualmente remuneradas.} de 400\$ de uma escrava do sr.\,dr.\,Clímaco Barbosa,\footnote{Clímaco Barbosa (1839--1912), natural de
...
no mês seguinte ganharia a forma final do estudo normativo-pragmático} ``Questão Jurídica''. \emph{Gama comentava a ``extravagante doutrina'' do
...
Antonio Feijó,\footnote{Ver nota \ref{feijo} à página \pageref{feijo}.} ministro e secretário de
...
pensamento ``libérrimo'',\footnote{Ver nota \ref{liberrimo} à página \pageref{liberrimo}.} sustentado pelo exmo.\,sr.\,conselheiro Nabuco de Araújo em um parecer, e por eméritos deputados e
...
\asterisc
  ...
  nascido neste libérrimo\footnote{Ver nota \ref{liberrimo} à página \pageref{liberrimo}.} país, um miserável escravo,
