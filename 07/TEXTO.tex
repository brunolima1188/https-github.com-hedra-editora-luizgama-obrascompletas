...
ser vereador, porque \emph{é} \emph{mulato e foi cativo}!\ldots{}''
...
\textsc{john brown}\footnote{Referência direta a John Brown (1800--1859),
...
\textsc{camillo gavião peixoto}''.\footnote{Camilo Gavião Peixoto (1830--1883)
...
\textsc{joão augusto de padua fleury}\footnote{João Augusto de Pádua Fleury
...
\textsc{sebastião josé pereira}''.\footnote{Sebastião José Pereira (1834--1881),
...
instrumentos do capricho e do arbítrio''. (\textsc{ramon salas} -- Lições de
...
\textsc{conde dos arcos}.''\footnote{Marcos Noronha de Brito (1771--1828), o
...
O bacharel \textsc{pedro de alcântara peixoto de miranda veras.}
...
\textsc{francisco martins de almeida.}
...
\textsc{sebastião raymundo ewerton.}
